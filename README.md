...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/postgres-18.svg)](https://hub.docker.com/r/alvistack/postgres-18)
...
- [`alvistack/postgres-18`](https://hub.docker.com/r/alvistack/postgres-18)
  - [`packer/docker-18/packer.json`](https://github.com/alvistack/docker-postgres/blob/master/packer/docker-18/packer.json)
...
Start PostgreSQL:
    ...
    # Pull latest image
    docker pull alvistack/postgres-18
